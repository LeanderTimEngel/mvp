...
export default function HeroSection({ openDemo }: HeroSectionProps) { // Destructure openDemo prop
  return (
    <div className="relative overflow-hidden pt-28 pb-12 sm:pt-32 sm:pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 sm:space-y-8 animate-fade-in">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-4">
              <button
                onClick={openDemo}
                className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-[#171c3f]/10 text-[#171c3f] hover:bg-[#171c3f]/20 h-11 px-6 sm:px-8 w-full sm:w-auto"
              >
              ...
              <Link
                href="#story-form"
                className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring bg-gradient-to-r from-[#fa6565] to-[#f2c955] text-white hover:opacity-90 h-11 px-6 sm:px-8 w-full sm:w-auto"
              >
                Create a Story
              </Link>
            </div>
          ...
          <div className="relative mt-8 lg:mt-0" id="story-form">
            ...
            <div className="relative bg-white/90 backdrop-blur-lg rounded-3xl shadow-xl p-5 sm:p-8 border border-[#f2c955]/20">
              <StoryForm />
            </div>
          </div>
        </div>
