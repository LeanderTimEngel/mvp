  ...
  return (
    <footer className="bg-gradient-to-b from-[#0f172a] to-[#0c1322] text-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-8 lg:grid-cols-4 mb-12">
          {/* Brand Section */}
          ...
          <div className="lg:ml-auto">
            <h3 className="text-lg font-bold mb-4 inline-flex items-center">
              <svg className="h-4 w-4 mr-2 opacity-80" fill="currentColor" viewBox="0 0 20 20">
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-gray-300 hover:text-white transition-colors text-sm inline-flex items-center group">
          ...
          <div>
            ...
            <div className="space-y-3">
              <p className="text-gray-300 text-sm flex items-start">
                <svg className="h-5 w-5 mr-2 flex-shrink-0 text-[#fa6565]" fill="currentColor" viewBox="0 0 20 20">
        ...
        {/* Copyright */}
        <div className="border-t border-gray-800/80 pt-8 text-center text-gray-400 flex flex-col sm:flex-row sm:justify-between items-center">
          <p className="text-sm mb-4 sm:mb-0">© {currentYear} Magical Stories. All rights reserved.</p>
