...
export default function Contact() {
  ...
  return (
    <main className="min-h-screen bg-[#fafaf8]">
      ...
      <div className="pt-20"> {/* Add padding-top equal to header height */} 
        ...
        <div className="relative pt-24 pb-16 bg-gradient-to-b from-white to-[#fafaf8]">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p className="text-xl text-gray-600 mb-6">Have questions or feedback? We'd love to hear from you!</p>
